...
class qr_code_generator:
    ...
    def generate_qr_code(canonical_xml, invoice_hash, signature_value, x509_certificate_content):
        try:
            ...
            #print("Generated Invoice Details:", invoice_details)  # Log invoice details for debugging
    ...
    def generate_qr_code_from_values(invoice_details):
        try:
            ...
            print("Generated QR Code Data (Base64):", base64.b64encode(data).decode())  # Log data

            return base64.b64encode(data).decode()
        except Exception as e:
            print(f"Error generating QR code from values: {str(e)}")
            return None
