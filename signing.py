...
def main():
    ...
    xml_file_path = 'templates\invoice.xml'

    # Test signing Documentcls
    try:
        private_key = 'MHQCAQEEIC7Q89+/THKeG1Nof+dnuq9AUzjVFoa0BqQVs7z4p5phoAcGBSuBBAAKoUQDQgAEoiisJH4eHRk76lVdkDHLuWrLLa2xM9+zmPMQqx9GCcxm/glwsk9lrI2wL6TqyEZeusj6ZDKZUvv8ODpA2ZK1RQ=='
        ...
        requestType = 'Compliance check API call'
        ...
        if response.status_code == 200:
            print("\n\nServer Response: \n" + api_helper.clean_up_json(response.text,requestType,url))
        else:
            print("\n\nServer Response: \n" + response.text)
